<%@ Page Title="" Language="C#" MasterPageFile="~/User/Bachatgat.master" 
    AutoEventWireup="true" CodeFile="Bachatgat login.aspx.cs" Inherits="User_Bachatgat_login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="login-title">Bachatgat Login</div>
            ...
            <div class="btn-container">
                ...
                <asp:Button ID="btncancle" runat="server" CssClass="btn" Text="Cancel" CausesValidation="false" />
            </div>
        </div>
    </div>
</asp:Content>
