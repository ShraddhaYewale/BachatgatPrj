<%@ Page Title="" Language="C#" MasterPageFile="~/User/Bachatgat.master" 
    AutoEventWireup="true" CodeFile="memberlogin.aspx.cs" Inherits="User_memberlogin" %>
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="btn-container">
                ...
                <asp:Button ID="btncancle" runat="server" CssClass="btn" Text="Cancel" OnClick="btncancle_Click" CausesValidation="false" />
            </div>
        </div>
    </div>
</asp:Content>
